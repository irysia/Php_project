            ...
            <form action="/newPost" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row align-items-center">
                        ...
                        <input name="topicId" class="sr-only" type="text" id="topicId" value="666">
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-outline-info my-2 my-sm-0 " type="button" data-dismiss="modal">close</button>
                ...
                <li class="list-group-item border-0">
                    ...
                    <div class="row my-3">
                        <div class="col-12 d-flex justify-content-start ml-5">
                            ...
                            <!-- add post on grid -->
                            <button class="btn btn-info my-2 my-sm-0  ml-3" data-id="<?= $one_topic->id ?>" onclick="document.getElementById('topicId').value = '<?= $one_topic->id ?>';" data-toggle="modal" data-target="#newPost">Ajouter un post</button>
                        </div>
                    </div>
