    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="navbar-nav ml-auto form-inline my-2 my-lg-0 ">
                <button class="btn btn-outline-info my-2 my-sm-0 mr-2" type="submit">Login</button>
                <button class="btn btn-info my-2 my-sm-0 mr-2" type="submit">Sign In</button>
...
<!-- NAV FOR SEARCH AND ADD THEME -->
<div class="row">
    <div class="col-12">
        <!-- search -->
        <form class=" form-inline my-2 my-lg-0">
            <input class="form-control col-11 mr-auto" type="search" placeholder="Chercher un thème" aria-label="Search">
  ...
  <div class="row my-3">
    <div class="col-12 d-flex justify-content-end">
        <!-- add theme -->
        <button class="btn btn-info my-2 my-sm-0 " type="submit">Ajouter un thème</button>
    </div>
  </div>
  ...
  <li class="list-group-item border-0">
    ...
    <div class="row my-3">
        <div class="col-12 d-flex justify-content-start ml-5">
            <!-- add post on grid -->
            <button class="btn btn-info my-2 my-sm-0  ml-3" type="submit">Ajouter un post</button>
        </div>
    </div>
...
?>
            ...
            <div class="card bg-primary text-white text-center p-3">
                <blockquote class="blockquote mb-0 card-body">
                    ...
                    <footer class="blockquote-footer">
                       ...
                       <cite title="Source Title">La Divine Comédie, Le Paradis (1321), XVI de Dante</cite>
                        </small>
                    </footer>
                </blockquote>
            </div>
            ...
            <div class="card">
                <div class="embed-responsive embed-responsive-21by9">
                <iframe width="100%" height="auto" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/223645672&color=%2300aabb&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
                </div>
            </div>
            <div class="card">
                <div class="embed-responsive embed-responsive-21by9">
                     <iframe src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTuKt8QQVFkai7iapvLyYCPlbjJ81uT9XLb5A&usqp=CAU" frameborder="0" scrolling="no" width="100%" height="auto" class="embed-responsive-item"></iframe>
                </div>
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
            ...
            <div class="card">
                <div class="embed-responsive embed-responsive-21by9">
                     <iframe src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-Y_5__1IvDSAWg_l0DTt4mrST_aHUvCiVew&usqp=CAU" frameborder="0" scrolling="no" width="100%" height="auto" class="embed-responsive-item"></iframe>
                </div>
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
  ...
  <!-- <li class="list-group-item border-0"> -->
    ...
    <!-- <div class="row container ml-5 post">
        <div class="card-columns  data-masonry='{"percentPosition": true }' ">
            <div class="card">
                <div class="embed-responsive embed-responsive-21by9">
                    <iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/229563163%3Fsecret_token%3Ds-rcXEy&color=%2300aabb&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
                </div>         
            </div>
            <div class="card bg-primary text-white text-center p-3">
                <blockquote class="blockquote mb-0 card-body">
                    <p>Événement qui cause de graves bouleversements, des morts.</p>
                    <footer class="blockquote-footer">
                        <small class=" text-white">
                       <cite title="Source Title">Dictionnaire Larousse</cite>
                        </small>
                    </footer>
                </blockquote>
            </div>
            <div class="card">
                <div class="embed-responsive embed-responsive-21by9">
                <iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/223645478%3Fsecret_token%3Ds-F7aus&color=%2300aabb&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
                </div>         
            </div>
            <div class="card">
                <div class="embed-responsive embed-responsive-21by9">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/6sCB0emlEa8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>  
            </div>
        </div>
    </div>  -->
  ...
  <!-- <li class="list-group-item border-0"> -->
    ...
    <!-- posts relatives grid -->
        ...
        <div class="card-columns  data-masonry='{"percentPosition": true }' ">
            <div class="card">
                <div class="embed-responsive embed-responsive-21by9">
                <iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/229587362%3Fsecret_token%3Ds-di1Pi&color=%2300aabb&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
                </div>         
            </div>
            <div class="card bg-primary text-white text-center p-3">
                <blockquote class="blockquote mb-0 card-body">
                    <p>“La danse, c’est de l’architecture en mouvement.”</p>
                    <footer class="blockquote-footer">
                        <small class=" text-white">
                       <cite title="Source Title">Jérôme Touzalin / Le Pommier</cite>
                        </small>
                    </footer>
                </blockquote>
            </div>
